        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Restuarents<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/restaurents">All Restaurents</a>
                            </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i>Clients<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                            <a href="{{route('manager.client')}}">All clients</a>
                            </li>
                            <li>
                                <a href="#">Todays clients</a>
                            </li>
